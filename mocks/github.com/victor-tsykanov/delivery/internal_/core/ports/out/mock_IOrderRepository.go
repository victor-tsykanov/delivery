...
func (_m *MockIOrderRepository) Get(ctx context.Context, id uuid.UUID) (*order.Order, error) {
...
func (_c *MockIOrderRepository_Get_Call) Run(run func(ctx context.Context, id uuid.UUID)) *MockIOrderRepository_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockIOrderRepository_Get_Call) RunAndReturn(run func(context.Context, uuid.UUID) (*order.Order, error)) *MockIOrderRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
