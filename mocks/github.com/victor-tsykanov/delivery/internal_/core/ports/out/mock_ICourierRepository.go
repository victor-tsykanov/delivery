...
func (_m *MockICourierRepository) Get(ctx context.Context, id uuid.UUID) (*courier.Courier, error) {
...
func (_c *MockICourierRepository_Get_Call) Run(run func(ctx context.Context, id uuid.UUID)) *MockICourierRepository_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockICourierRepository_Get_Call) RunAndReturn(run func(context.Context, uuid.UUID) (*courier.Courier, error)) *MockICourierRepository_Get_Call {
	_c.Call.Return(run)
	return _c
}
